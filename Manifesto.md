...
1.  The distribution shall not interact with Drupal's Configuration Management system. The individual developer shall be responsible for using Configuration Management in a manner appropriate for each site instance.
